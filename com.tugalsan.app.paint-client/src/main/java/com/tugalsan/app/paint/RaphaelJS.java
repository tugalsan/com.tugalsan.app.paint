  ...
  protected static class Element extends JavaScriptObject {
    ...
    public final native Element animate(JavaScriptObject newAttrs, int ms, AnimationCallback callback) /*-{
      return this.animate(newAttrs, ms, function() {
        callback.@com.tugalsan.app.paint.AnimationCallback::onComplete()();
      });
    }-*/;
    ...
    public final native void drag(DragCallback callback) /*-{
      var start = function (x, y) {
        callback.@com.tugalsan.app.paint.DragCallback::onStart(DD)(x,y);
      },
      move = function (dx, dy, x, y) {
        callback.@com.tugalsan.app.paint.DragCallback::onMove(DDDD)(dx,dy,x,y);
      },
      up = function () {
        callback.@com.tugalsan.app.paint.DragCallback::onEnd()();
      };
